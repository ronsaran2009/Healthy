...
public class SleepFormFragment extends android.support.v4.app.Fragment {
    SQLiteDatabase myDB;
    ContentValues _row;
    Bundle _bundle;
    int _bundleInt;
    ...
    void initSaveBtn(){
        ...
        _saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (_dateStr.isEmpty() || _sleepStr.isEmpty() || _wakeStr.isEmpty()) {
                    Toast.makeText(getActivity(), "กรุณากรอกข้อมูลให้ครบถ้วน", Toast.LENGTH_SHORT).show();
                    Log.d("SLEEP_FORM", "EMPTY INFORMATIONN");
                }

                else if (_bundle != null) { //เช็คว่าข้อมูลไหนมีการอัพเดตมั่ง
